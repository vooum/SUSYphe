...
def ConvertToInputfile(data, InputDir):
	...
	for index, row in data.iterrows():
		...
		for name in par_names:
			...
			# 	if max(pow(point_data['ZV21'], 2), pow(point_data['ZV22'], 2), pow(point_data['ZV23'], 2)) == pow(point_data['ZV21'], 2):	
			# 		point_data['Sv2'] = point_data['Sv_2']
			# 		point_data['Sv3'] = point_data['Sv_3']
			# 	else:
			# 		point_data['Sv2'] = point_data['Sv_3']
			# 		point_data['Sv3'] = point_data['Sv_2']
			# elif max(pow(point_data['ZV21'], 2), pow(point_data['ZV22'], 2), pow(point_data['ZV23'], 2)) == pow(point_data['ZV22'], 2):
			# 	point_data['Sv1'] = point_data['Sv_2']
			...
			# elif max(pow(point_data['ZV31'], 2), pow(point_data['ZV32'], 2), pow(point_data['ZV33'], 2)) == pow(point_data['ZV32'], 2):
...
if __name__ == '__main__':
	...
	path_for_writing = 'InputsForProspino/EWK_SMUSMU'
